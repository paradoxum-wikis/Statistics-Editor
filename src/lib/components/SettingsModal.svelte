      ...
      <div class="settings-grid">
        <div class="settings-item">
          <div class="settings-label-group">
            <label for="debug-mode" class="settings-label"> Debug Mode </label>
        ...
        <div class="settings-item">
          <div class="settings-label-group">
            ...
            <p class="settings-help-text">
              Hides the visual wrapper inside table cells, letting the number
              sit directly in the cell.
            </p>
          </div>
          <Switch.Root
        ...
        <div class="settings-item">
          <div class="settings-label-group">
            ...
            <p class="settings-help-text">
              Prevents the table from stretching to the full width, keeping it
        ...
        <div class="settings-item">
          <div class="settings-label-group">
            ...
            <p class="settings-help-text">
              Clears the input box when you click on a cell instead of keeping
