...
<div class="space-y-0">
  <Card class="max-w-3xl mx-auto space-y-6 p-8">
    <div class="space-y-2">
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <SubtleRow class="p-4">
          ...
          <p class="text-sm text-muted-foreground">
            Use the search bar in the top right corner to find and load any
            tower from the game.
          </p>
        </SubtleRow>
        ...
        <SubtleRow class="p-4">
          ...
          <p class="text-sm text-muted-foreground">
            Export the stats you've edited and contribute them to the TDS Wiki
